...
import com.archos.mediacenter.video.player.TimerPickerAbstract;


public class TimerDelayTVPicker extends TimerPickerAbstract implements TVSlaveView {

    private TimerDelayTVPicker slaveView;
    ...
    public TimerDelayTVPicker(Context context) {
        this(context, null);
    }

    public TimerDelayTVPicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimerDelayTVPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch(msg.what) {
            case CHANGE_DELAY:
                if (mOnDelayChangedListener != null) {
                    mOnDelayChangedListener.onTimerChanged(this, getDelay());
                }
                break;
        }
    }
    ...
    public void setSlaveView(View v) {
        // TODO Auto-generated method stub
        if(v instanceof TimerDelayTVPicker){
            slaveView = (TimerDelayTVPicker) v;
